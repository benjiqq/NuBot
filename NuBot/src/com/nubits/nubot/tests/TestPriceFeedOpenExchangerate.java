 ...
 */
public class TestPriceFeedOpenExchangerate {

    private static final Logger LOG = Logger
            .getLogger(TestPriceFeedOpenExchangerate.class.getName());
    AbstractPriceFeed feed;
    CurrencyPair pair;

    public static void main(String a[]) {
        
        TestPriceFeedOpenExchangerate test = new TestPriceFeedOpenExchangerate();
        
        test.init();

        test.pair = Constant.HKD_USD;

        test.execute();
                
        test.init();

        test.pair = Constant.PHP_USD;
    ...
    private void init() {
        ...
        String logsFolder = Global.settings.getProperty("log_path")
                + folderName;
        try {
        ...
        System.setProperty("javax.net.ssl.trustStore",
                Global.settings.getProperty("keystore_path"));
        System.setProperty("javax.net.ssl.trustStorePassword",
                Global.settings.getProperty("keystore_pass"));
